...
class Banner extends Widget_Base {
	...
	protected function render() {
		...
		$this->add_render_attribute( 'button_all', 'class', [ 'ecomus-banner__button--all', 'em-absolute' ] );
        ?>

		<div <?php echo $this->get_render_attribute_string( 'banner' ); ?>>
			<?php echo ! empty( $settings['button_link']['url'] ) && $settings['button_link_type'] == 'slide' ? '<a '. $this->get_render_attribute_string( 'button_all' ) .' href="'. esc_url( $settings['button_link']['url'] ) .'"><span class="screen-reader-text">'. wp_kses_post( $settings['button_text'] ) .'</span></a>' : ''; ?>
