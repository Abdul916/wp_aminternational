...
class Image_Content_Slider extends Carousel_Widget_Base {
	...
	protected function render() {
		...
		$this->add_render_attribute( 'button_all', 'class', [ 'ecomus-image-content-slider__button--all', 'em-absolute' ] );
    ?>
            ...
            <?php
                ...
                ?>
                    <div <?php echo $this->get_render_attribute_string( $slide_item ); ?>>
                        ...
                        <?php echo ! empty( $slide['button_link']['url'] ) && $slide['button_link_type'] == 'slide' ? '<a '. $this->get_render_attribute_string( 'button_all' ) .' href="'. esc_url( $slide['button_link']['url'] ) .'"><span class="screen-reader-text">'. esc_html( $slide['button_text'] ) .'</span></a>' : ''; ?>
                    </div>
            <?php
                }
                ?>
