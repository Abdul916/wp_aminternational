			...
			<div <?php echo $this->get_render_attribute_string( $item_key ); ?>>
				<div <?php echo $this->get_render_attribute_string( 'view_all_image' ); ?>>
					<?php if( !empty( $settings['view_all_btn_link']['url'] ) ) {
						$link_for = esc_html__('Link for', 'ecomus-addons');
						$link_for .= ' ' . $settings['view_all_btn_title'];
					} ?>
					<?php if( !empty( $settings['view_all_btn_link']['url'] ) ) : ?><a class="ecomus-image-box-carousel__link em-ratio" href="<?php echo esc_url( $settings['view_all_btn_link']['url'] ); ?>" aria-label="<?php echo esc_attr($link_for);?>"><?php else: ?> <div class="ecomus-image-box-grid__link"><?php endif; ?>
