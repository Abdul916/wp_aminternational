	...
	protected function section_style() {
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .ecomus-product-tabs-grid__heading span',
				'condition'   => [
					'show_heading!' => 'yes',
				],
			]
		...
		$this->add_group_control(
			...
			[
				...
				'selector' => '{{WRAPPER}} .ecomus-product-tabs-grid__heading.has-heading span',
				'condition'   => [
					'show_heading' => 'yes',
				],
			]
            ...
            echo '<div '. $this->get_render_attribute_string( 'heading' ) . '>';
				if ( $settings['show_heading'] == 'yes' && ! empty( $settings['heading_text'] ) ) {
					...
					if( ! empty( $settings['button_all_text'] ) && ! empty( $settings['button_all_link']['url'] ) ) {
						...
						echo '<a '. $this->get_render_attribute_string( 'button_all' ) .' class="ecomus-product-tabs-grid__button">'. esc_html( $settings['button_all_text'] ) . \Ecomus\Addons\Helper::get_svg( 'arrow-top' ). '</a>';
					}
				if ( $settings['show_heading'] == 'yes' && ! empty( $settings['heading_text'] ) ) {
            		echo '</div>';
				}
