...
class Image_Box_Grid extends Widget_Base {
	...
	protected function render() {
        ...
        $this->add_render_attribute( 'title', 'class', [ 'ecomus-image-box-grid__title', 'text-center', 'em-font-semibold' ] );
                ...
                <?php foreach( $settings['items'] as $index => $item ) : ?>
                    ...
                    <div <?php echo $this->get_render_attribute_string( $slide_item ); ?>>
                        <div <?php echo $this->get_render_attribute_string( 'image' ); ?> data-type="<?php echo esc_attr( $item['type'] ); ?>">
                            ...
                            <?php if( !empty( $item['link']['url'] ) ) : ?><a class="ecomus-image-box-grid__link em-ratio" href="<?php echo esc_url( $item['link']['url'] ); ?>" aria-label="<?php echo esc_attr($link_for);?>"><?php else: ?> <div class="ecomus-image-box-grid__link"><?php endif; ?>
                                ...
                                <?php } ?>
                            <?php if( ! empty( $item['link']['url'] ) ) : ?></a><?php else: ?></div><?php endif; ?>
						...
						<div <?php echo $this->get_render_attribute_string( 'content' ); ?>>
							<?php if( ! empty( $item['title'] ) ) : ?>
								<a <?php echo $this->get_render_attribute_string( 'title' ); ?> href="<?php echo esc_url( $item['link']['url'] ); ?>">
