...
<div id="reviews" class="woocommerce-Reviews">
	...
	?>
		...
		<button class="ecomus-form-review em-button-outline" type="button" data-toggle="modal" data-target="ecomus-review-form"><?php echo esc_html__( 'Write a review', 'ecomus' ); ?></button>
		<?php else : ?>
